...
<body>
  <div class="container">
    <header>
      <a href="http://localhost:8080/board/list"><h1>CGV</h1></a>
			...
			<section id="container">
				<form role="form" method="post" action="/board/write">
					<table class = "table table-hover">
						<tr><th>PostNumber</th><th>상품사진</th><th>상품설명</th><th>가격</th>Toys<th>작성자</th><th>조회수</th><th>작성일</th><th>상태</th></tr>
						
						<c:forEach items="${list_Toys}" var = "list">
							<tr>
	          ...
	          <br>
				...
				<div class="page">
				    ...
				    <c:forEach begin="${pageMaker.startPage}" end="${pageMaker.endPage}" var="idx">
				    	<li><a href="list_Toys${pageMaker.makeQuery(idx)}">${idx}</a></li>
				    </c:forEach>
				
				    <c:if test="${pageMaker.next && pageMaker.endPage > 0}">
				    	<li><a href="list_Toys${pageMaker.makeQuery(pageMaker.endPage + 1)}">>></a></li>
